...
/// <summary>
/// 근거리 유닛 간 난전 처리 컨트롤러.
/// A* 기반 경로 탐색을 통해 적절한 위치로 유닛을 이동시킴.
/// 전투 중 겹침 해소 및 전략적 이동을 위한 로직 처리.
/// </summary>
public class Army_ComBatController
{
    ...
    public float interval = 0.5f; // 0.5초마다 전투 경로 체크
    ...
    /// <summary>
    /// 전투에 돌입할 Army 쌍을 combatFinght 리스트에 추가
    /// </summary>
    ...
    /// <summary>
    /// 근거리 유닛 간 난전 발생 시 경로 계산 및 이동 타겟 설정
    /// </summary>
